...
namespace Liberty.SaveManager.Flexibility
{
    ...
    public class StructureValueCollection
    {
        ...
        private Dictionary<string, byte> _byteValues = new Dictionary<string, byte>();
        ...
        public bool HasByte(string name)
        {
            return _byteValues.ContainsKey(name);
        }
        ...
        /// <summary>
        /// Finds a byte field with a given name and retrieves its value if it is found.
        /// </summary>
        /// <param name="name">The name of the string field to find.</param>
        /// <param name="value">The variable to store the field's value to (if the field exists).</param>
        public bool FindByte(string name, out byte value)
        {
            return _byteValues.TryGetValue(name, out value);
        }
        ...
        /// <summary>
        /// Attempts to retrieve the value of a byte field,
        /// returning a specified default value if it does not exist.
        /// </summary>
        /// <param name="name">The name of the string field to retrieve the value of.</param>
        /// <param name="defaultValue">The value to return if the field is not found.</param>
