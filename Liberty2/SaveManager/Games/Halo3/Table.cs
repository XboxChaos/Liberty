...
namespace Liberty.SaveManager.Games.Halo3
{
    public class Table
    {
        ...
        /// <param name="reader">The EndianReader to read from. It will be positioned after the datum index.</param>
        ...
        public delegate bool ReadEntriesCallback(Table table, EndianReader reader, DatumIndex index, uint size, long offset);

        /// <summary>
        /// Constructs a new Table and reads the header.
        /// </summary>
        /// <param name="reader">
        /// The EndianReader to read from. It should be positioned at the start of the table header.
        /// When the function finishes, it will point to the first entry in the entry list (see the HeaderSize constant).
        /// </param>
        public Table(EndianReader reader)
        {
        ...
        public void ReadEntries(EndianReader reader, ReadEntriesCallback callback)
        {
