...
using Liberty.SaveManager.MathUtil;
...
namespace Liberty.SaveManager.Games.Halo3
{
    ...
    {
        /// <summary>
        /// Constructs a new GameObject based off of an ObjectEntry and data read from a EndianReader.
        /// </summary>
        ...
        public GameObject(ObjectEntry entry, EndianReader reader)
        {
            _entry = entry;
        ...
        /// <summary>
        /// Reads data from a EndianReader. Override this in a derived class to read object-specific data.
        /// </summary>
        /// <param name="reader">The EndianReader to read from. No guarantees can be made about its ending offset.</param>
        /// <param name="baseOffset">The offset of the start of the object data.</param>
        protected virtual void ReadFrom(EndianReader reader, long baseOffset)
        {
