...
namespace Liberty.Halo4
{
    public class BipedObject : GameObject
    {
        public BipedObject(ObjectEntry entry, SaveReader reader)
            : base(entry, reader)
        {
            if (entry.TagGroup != Halo4.TagGroup.Bipd)
        ...
        protected override void ReadFrom(SaveReader reader, long baseOffset)
        {
            ...
            _pulseGrenades = reader.ReadSByte();
        }
        ...
        public override void Update(SaveWriter writer)
        {
            ...
            writer.WriteSByte(_pulseGrenades);
        }
        ...
        /// <summary>
        /// The number of pulse grenades the biped is carrying.
        /// </summary>
        public sbyte PulseGrenades
        {
            get { return _pulseGrenades; }
            set { _pulseGrenades = value; }
        }
        #endregion
        ...
        private sbyte _pulseGrenades;

        // Offsets
        private const int WeaponsOffset = 0x260;
        private const int GrenadesOffset = 0x666;
    }
}
